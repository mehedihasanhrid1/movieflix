...
const Errorpage = () => {
  return (
    <section className="flex items-center h-screen bg-gray-900">
          ...
          <div className="flex flex-wrap items-center ">
            <div className="w-full px-2 lg:px-4 xl:pr-12 lg:w-2/4 lg:mb-0 lg:py-0">
              <div className="text-center lg:text-left xl:text-center">
                <h1 className="inline-block mb-8 mt-8 md:mt-12 lg:mt-0 font-semibold  text-7xl lg:text-9xl text-gray-400">
                  Oops!
                </h1>
                <h2 className="mb-8 text-2xl font-semibold  lg:text-4xl text-gray-400">
                  404 Page not found
                </h2>
                ...
                <div className="flex flex-wrap items-center justify-start px-8 lg:px-0 pb-8 xl:justify-center xl:ml-5">
                  ...
                  <a
                    href=""
                    className="w-full px-8 py-4 text-base font-medium  uppercase border rounded-full border-gray-500 hover:border-blue-800 text-gray-400 lg:w-auto hover:text-gray-200  md:w-full hover:bg-blue-800"
                  >
                    Report Problem
                  </a>
                </div>
